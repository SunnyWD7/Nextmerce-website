...
function Box() {
  return (
   <section className='w-full px-4 dark:bg-[#0f172a]'>
    <div className="box max-w-[1300px] mx-auto py-10 flex flex-col lg:flex-row gap-8 ">
        <div className="left bg-[#dbf4f3] rounded-xl dark:bg-[#1e293b] dark:text-white p-7 sm:flex justify-between  items-center lg:w-[50%] ">
            <div className="leftImage flex justify-center p-6 ">
                <img src="./src/assets/running.webp" alt="" className='sm:w-[22vw] md:w-[15vw]' />
            </div>
            <div className="right-text  flex flex-col gap-[6px] ">
                <h4 className='text-lg '>Foldable Motorised Treadmill</h4>
                <h1 className=' md:text-xl lg:text-3xl font-bold text-[#1c274c] sm:self-end'>Workout At Home</h1>
                <h2 className='text-xl font-semibold text-[#02aaa4] sm:self-end'>Flat 20% off</h2>
                <button className='my-8 py-2 px-8 bg-[#02aaa4] rounded-3xl self-start sm:self-end text-white'>Grab Now</button>
            </div>
        </div>
        <div className="right bg-[#ffece1] rounded-xl dark:bg-[#1e293b] dark:text-white p-7 sm:flex justify-between  items-center lg:w-[50%] ">
            ...
            <div className="right-text  flex flex-col gap-1.5">
                ...
                <h1 className=' text-xl sm:text-2xl md:text-xl  lg:text-3xl  font-bold text-[#1c274c] '>Up to 40% off</h1>
